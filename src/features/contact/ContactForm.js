                ...
                <View className=''>
                    <View id='inputForm' className='space-y-8 mt-8'>
                        ...
                        <View className='flex space-x-2'>
                            <TouchableOpacity onPress={handleAdd} className='transition flex text-white bg-blue-500 hover:bg-blue-600 hover:delay-150 rounded-lg font-semibold items-center space-x-3 py-1 px-3'>
                                <Text>Add</Text>
                            </TouchableOpacity>

                            <TouchableOpacity type='TouchableOpacity' onPress={() => setContact({ name: '', phone: '' })} className='transition flex text-white bg-amber-500 hover:bg-amber-600 hover:delay-150 rounded-lg font-semibold items-center space-x-2 py-1 px-3'>
                                <Text>Cancel</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
